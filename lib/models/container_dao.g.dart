...
_ContainerDao _$ContainerDaoFromJson(Map<String, dynamic> json) =>
    _ContainerDao(
      ...
      sequentialBuild: $enumDecode(
        _$SequentialBuildEnumMap,
        json['sequentialBuild'],
      ),
...
Map<String, dynamic> _$ContainerDaoToJson(_ContainerDao instance) =>
    <String, dynamic>{
      'id': instance.id,
