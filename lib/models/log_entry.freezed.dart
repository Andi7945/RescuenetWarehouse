...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String itemId,  String containerId,  int count, @TimestampConverter()  DateTime date,  String user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LogEntry() when $default != null:
return $default(_that.id,_that.itemId,_that.containerId,_that.count,_that.date,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String itemId,  String containerId,  int count, @TimestampConverter()  DateTime date,  String user)  $default,) {final _that = this;
switch (_that) {
case _LogEntry():
return $default(_that.id,_that.itemId,_that.containerId,_that.count,_that.date,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String itemId,  String containerId,  int count, @TimestampConverter()  DateTime date,  String user)?  $default,) {final _that = this;
switch (_that) {
case _LogEntry() when $default != null:
return $default(_that.id,_that.itemId,_that.containerId,_that.count,_that.date,_that.user);case _:
  return null;
