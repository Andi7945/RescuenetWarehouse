...
/// Adds pattern-matching-related methods to [ContainerDao].
extension ContainerDaoPatterns on ContainerDao {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ContainerDao value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ContainerDao() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ContainerDao value)  $default,){
final _that = this;
switch (_that) {
case _ContainerDao():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ContainerDao value)?  $default,){
final _that = this;
switch (_that) {
case _ContainerDao() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int number,  String name,  String? description,  String? typeId,  SequentialBuild sequentialBuild,  String? moduleDestinationId,  String? currentLocationId,  bool isReady,  bool toDeploy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContainerDao() when $default != null:
return $default(_that.id,_that.number,_that.name,_that.description,_that.typeId,_that.sequentialBuild,_that.moduleDestinationId,_that.currentLocationId,_that.isReady,_that.toDeploy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int number,  String name,  String? description,  String? typeId,  SequentialBuild sequentialBuild,  String? moduleDestinationId,  String? currentLocationId,  bool isReady,  bool toDeploy)  $default,) {final _that = this;
switch (_that) {
case _ContainerDao():
return $default(_that.id,_that.number,_that.name,_that.description,_that.typeId,_that.sequentialBuild,_that.moduleDestinationId,_that.currentLocationId,_that.isReady,_that.toDeploy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int number,  String name,  String? description,  String? typeId,  SequentialBuild sequentialBuild,  String? moduleDestinationId,  String? currentLocationId,  bool isReady,  bool toDeploy)?  $default,) {final _that = this;
switch (_that) {
case _ContainerDao() when $default != null:
return $default(_that.id,_that.number,_that.name,_that.description,_that.typeId,_that.sequentialBuild,_that.moduleDestinationId,_that.currentLocationId,_that.isReady,_that.toDeploy);case _:
  return null;
