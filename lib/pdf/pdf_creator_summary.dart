...
Future<pw.Document> Function(PdfPageFormat) createSummaryPdf(
    ...
    (PdfPageFormat format) async {
      ...
      pdf.addPage(await _page(summary)(format));
      return pdf;
    };

Future<pw.Page> Function(PdfPageFormat) _page(SummaryPdf summary) =>
    (format) async => await pageHeaderFooter(
        format,
        await _provideHeader(summary),
