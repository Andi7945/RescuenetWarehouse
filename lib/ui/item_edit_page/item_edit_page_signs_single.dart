...
import 'package:rescuenet_warehouse/ui/item_edit_page/item_edit_page_signs_single_documents.dart';
      ...
      children: [
        ...
        SizedBox(
          ...
          child: RescueInputText(
            ...
            onChange: (changed) => fnUpdated(sign.copyWith(unNumber: changed)),
          ),
        ),
      ],
    ),
