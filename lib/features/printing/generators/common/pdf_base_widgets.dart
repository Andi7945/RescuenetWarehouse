...
// Text styles
pw.Widget smallText(String text, [PdfColor? backgroundColor]) => pw.Text(text,
    style: pw.TextStyle(
...
pw.Widget bigger(String text) => pw.Text(text, style: const pw.TextStyle(fontSize: 16.0));

pw.Widget biggerAndFat(String text) => pw.Text(text,
...
Future<pw.Widget> _perGood(PackingDangerousGood good,
