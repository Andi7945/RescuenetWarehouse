...
class AssignmentByContainerSingleItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Row(
      children: [_itemCard(), _assignArea(context, ref, operationKey)],
    );
  }
  ...
  _iconButton(
    ...
    iconSize: 56,
    onPressed: isOperationActive
        ? null
        : () => _updateAssignmentCount(context, ref, operationKey, newCount),
  ...
  Future<void> _updateAssignmentCount(
    ...
    await ref
        ...
        .catchError((error) {
          if (context.mounted) {
            _showErrorMessage(context, error, operationKey, newCount, ref);
          }
        });
  }
