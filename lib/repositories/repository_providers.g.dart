...
/// Returns Firebase implementation in production, Mock implementation in tests.
///
/// Copied from [containerTypeRepository].
@ProviderFor(containerTypeRepository)
final containerTypeRepositoryProvider =
...
/// Returns Firebase implementation in production, Mock implementation in tests.
///
/// Copied from [currentLocationRepository].
@ProviderFor(currentLocationRepository)
...
/// Returns Firebase implementation in production, Mock implementation in tests.
///
/// Copied from [moduleDestinationRepository].
@ProviderFor(moduleDestinationRepository)
final moduleDestinationRepositoryProvider =
